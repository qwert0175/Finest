...
class CustomRegisterSerializer(RegisterSerializer):
    ...
    gender = serializers.ChoiceField(required=False, allow_blank=True, choices=User.GENDER_CHOICES, allow_null=True)
    age = serializers.IntegerField(required=False, max_value=150, allow_null=True)
